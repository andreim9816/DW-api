...
public class MapperOLTP {
    ...
    public Zbor toEntity(ZborDtoOLTP dto) {
        return Zbor.builder()
                .id(dto.getId())
                .operatorZbor(operatorZborRepositoryLow.findById(dto.getOperatorId()).orElse(null))
...
//                .id(dto.getId())
                ...
                .client(clientRepositoryLow.findById(dto.getClientId()).orElse(null))
                .zbor(zborRepositoryLow.findById(dto.getZborId()).orElse(null))
                .clasaZbor(clasaZborRepositoryLow.findById(dto.getClasaZborId()).orElse(null))
                .metodaPlata(metodaPlataRepositoryLow.findById(dto.getMetodaPlataId()).orElse(null))
                .build();
    }
